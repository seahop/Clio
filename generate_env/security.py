...
def generate_security_credentials(args):
    ...
    # Check if .env exists to determine if we need to generate new credentials
    if not os.path.exists('.env'):
        ...
        print("\033[33m.env file already exists, skipping credential generation\033[0m")
...
def update_env_with_google_sso(args):
    """Update an existing .env file with Google SSO configuration."""
